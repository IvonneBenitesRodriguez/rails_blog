...
RSpec.describe 'User Features', type: :feature do
  before do
    @author_user = User.create!(name: 'Elena', photo: 'https://example.com/ella_profile.png',
                                bio: 'Educator from Peru.')
    @commenter_user = User.create!(name: 'Ivonne Benites', photo: 'https://example.com/may_profile.png',
                                   bio: 'Student from Peru.')
